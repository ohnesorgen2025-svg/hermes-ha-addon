...
[run] Updating Hermes Agent source from https://github.com/ohnesorgen2025-svg/hermes-agent.git (9bf6ea406af79307992e25dde95faa51a451d5c7)...
HEAD is now at 9bf6ea4 ...
[run] Installing Hermes Agent...
 + aiohttp==3.13.5
 ~ hermes-agent==0.13.0 (from file:///config/.hermes/hermes-agent)
[run] Starting Hermes Gateway
