...
[run] Updating Hermes Agent source from https://github.com/ohnesorgen2025-svg/hermes-agent.git (fa37ec2142845ade1e6b0fb9e06e34d28fbd08c4)...
HEAD is now at fa37ec2 ...
[run] Installing Hermes Agent...
 + aiohttp==3.13.5
 ~ hermes-agent==0.13.0 (from file:///config/.hermes/hermes-agent)
[run] Starting Hermes Gateway
