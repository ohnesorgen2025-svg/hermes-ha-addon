...
[run] Updating Hermes Agent source from https://github.com/ohnesorgen2025-svg/hermes-agent.git (59a24be8c5405144849af96b6300522c22508905)...
HEAD is now at 59a24be8c ...
[run] Installing Hermes Agent...
 + aiohttp==3.13.5
 ~ hermes-agent==0.13.0 (from file:///config/.hermes/hermes-agent)
[run] Starting Hermes Gateway
